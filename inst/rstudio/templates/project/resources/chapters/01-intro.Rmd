...
This document was rendered using `r knitr::combine_words(render_cite)`. The following *R* packages were used to run analyses, generate figures, and create tables: `r knitr::combine_words(loaded_cite)`.
